  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto">       
        ...
        <li class="nav-item active"><a href="{{ url('/site') }}" class="nav-link">Site</a></li>
...
<!-- END nav -->
<section class="hero-wrap hero-wrap-2" style="background-image: url('template/images/banner-sistema.png');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
        <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">Home <i class="fa fa-chevron-right"></i></a></span> <span>Lista de Sistemas <i class="fa fa-chevron-right"></i></span></p>
        <h1 class="mb-0 bread">Sistema</h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="col-lg-3 sidebar">
      ...
      <div class="sidebar-box bg-white p-4 ftco-animate">
        ...
        <form action="#" class="browse-form">
          ...
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> PHP</label><br>
          <label for="option-category-2"><input type="checkbox" id="option-category-2" name="vehicle" value=""> JavaScript</label><br>
          <label for="option-category-3"><input type="checkbox" id="option-category-3" name="vehicle" value=""> Python</label><br>
          <label for="option-category-3"><input type="checkbox" id="option-category-3" name="vehicle" value=""> Ruby Rails</label><br>
          <label for="option-category-3"><input type="checkbox" id="option-category-3" name="vehicle" value=""> Java</label><br>
          <label for="option-category-4"><input type="checkbox" id="option-category-4" name="vehicle" value=""> C#</label><br>
          <label for="option-category-5"><input type="checkbox" id="option-category-5" name="vehicle" value=""> React</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> TypeScript</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Vue.js</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Node.js</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> JQuary</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Laravel</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Zend Framework</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> CakePHP</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> CodeIgniter</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Scriptcase</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Django</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Angular</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Symfony</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> C++</label><br>
          <label for="option-category-6"><input type="checkbox" id="option-category-6" name="vehicle" value=""> Bootstrap</label><br>
      ...
      <div class="row">
        <div class="col-md-6 d-flex align-items-stretch ftco-animate">
          <div class="project-wrap">
            <a href="{{ route('sis-vtecfacil-detalhe') }}" class="img" style="background-image: url(template/images/vtecfacil_2_0.jpg);">
            <span class="price">Sistema</span>
            </a>
            <div class="text p-4">
              <h3><a href="#">Gestão empresarial vtecfácil v.2.0</a></h3>              
              <p class="advisor">Adquirido: <span>318</span></p>
              <ul class="d-flex justify-content-between">
                <li><span class="flaticon-shower"></span><del>R$ 139,99</del></li>
                <li class="price">R$ 99,00</li>
              </ul>
            </div>
          </div>
        </div>
